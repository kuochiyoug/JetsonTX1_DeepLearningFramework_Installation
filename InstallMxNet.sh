...
rm ./make/config.mk
cp $installation_folder/mxnet0_11_JetsonTX1/config.mk .
cp $installation_folder/mxnet0_11_JetsonTX1/config.mk ./make/
rm ./mshadow/make/mshadow.mk
cp $installation_folder/mxnet0_11_JetsonTX1/mshadow.mk ./mshadow/make/
